                ...
                <div class="row">
                    <div class="form-group">
                        @if($user->role == 'admin' || $user->permission >= '4')
                            <h3>Modification des informations d'un employé</h3>
                            <form action = "{{route("editEmployePut",$user2->idProfile)}}" method = "post">
                                @csrf
                                @method('PUT')
                                <label>Nom : </label>
                                <input class="form-control" required maxlength='200' type="text" id="name" value='{{ $user2->name }}' name="name"><br>

                                <label>Email : </label>
                                <input class="form-control" type="text" maxlength='200' id="email" value='{{ $user2->email }}' name="email"><br>
