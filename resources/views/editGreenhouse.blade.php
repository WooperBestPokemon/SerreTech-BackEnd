            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    @if($user->role == 'admin' || $user->permission >= '2')
                        <h3>Modification des informations de la serre</h3>

                        <form action = "{{route('editgreenhousePut',$idGreenHouse)}}" method = "post">
                            @csrf
                            @method('PUT')
                            <label>Nom : </label>
                            <input class="form-control" required maxlength='200' type="text" id="name" value='{{ $name}}' name="name"><br>

                            <label>Description : </label>
                            <input class="form-control" type="text" maxlength='200' id="description" value='{{ $description }}' name="description"><br>
                            <label>Image :</label>
                            <input class="form-control" value='{{ $img }}' name="img" type="url" placeholder="Url du produit" maxlength='999'>
                            <br>
