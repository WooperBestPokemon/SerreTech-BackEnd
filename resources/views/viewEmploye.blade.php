            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    @if( $user->role == 'admin' ||$users->permission >= '3')
                        ...
                        <button type="button" class="btn btn-info btn-sml btn-round"><i class="pe-7s-users"></i><a  href="{{route('addEmploye')}}"> Ajouter Utilisateur</a></button>
                    @endif
                </div>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        @foreach($employe as $employes)
                                            <tr>
                                                ...
                                                @if($user->role== 'admin')
                                                    <th><form action="{{route('deleteuser',$employes["idProfile"])}}" method="post" onclick="return confirm('Êtes-vous sur?')"><input class="btn btn-danger" type="submit" value="Effacer" /> @method('delete') @csrf </form></th>
                                                @endif
                                            </tr>
                                        @endforeach
                                    </table>
