                    ...
                    <div class="form-group">
                        @if($user->role == 'admin' || $user->permission >= '4')
                            ...
                            <form action = "{{route("addEmployePost")}}" method = "post">
                                ...
                                <label>Email : </label>
                                <input class="form-control" required type="email" maxlength='200' id="email" name="email"><br>

                                <label>Mot de passe : </label>
                                <input class="form-control" required maxlength='200' type="password" id="password" name="password"><br>
                                ...
                                <input class="form-control" type="hidden" maxlength='200' id="idCompany" value='{{ $user->idCompany }}' name="idCompany">
