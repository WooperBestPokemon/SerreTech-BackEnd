                ...
                <div class="row">
                    <div class="form-group">
                        @if($user->role == 'admin' || $user->permission >= '3')
                            <h3>Informations de la nouvelle zone</h3>
                            <form action = "{{route('addzonePost')}}" method = "post">
                                @csrf
                                @method('POST')
                                <label>Nom : </label>
                                <input class="form-control" required type="text" maxlength='200' id="name" name="name"><br>
                                ...
                                <select class="form-select" required name="typeFood" id="typeFood">
                                ...
                                <select class="form-select" required name="idGreenhouse" id="idGreenhouse">
