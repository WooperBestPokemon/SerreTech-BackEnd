            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <h3>Modification de capteur</h3>
                    ...
                    <form action = "{{route("editsensorPut",$sensors->idSensor)}}" method = "post">
                        ...
                        @method('PUT')
                        <label>Nom : </label>
                        <input  class="form-control" required maxlength='200' type="text" id="name" value='{{ $sensors->name }}' name="name"><br>

                        <label>Description : </label>
                        <input class="form-control" type="text" maxlength='200' id="description" value='{{ $sensors->description }}' name="description"><br>

                        <label>Type de données : </label>
                        <select class="form-select" required name="typeData" id="typeData">
                        ...
                        <label>Choisir la zone :</label>
                            <select class="form-select" required name="idZone" id="idZone">
